...
* Asking models whether some action is permissible
* Interacting with the model
* Passing parameters and/or body from the request to the model
...
* Displaying data, errors, and success messages
...
* Controllers that don't map to one resource/model.
* Controllers that have more than the basic CRUD actions.
* Controllers that interact with models with more than 2-3 lines of code.

### Moving from Maturity Level 2 to 3
* Model methods that are more than 8-10 lines long.
* More than 3 or 4 methods in a model that relate to the same action.
